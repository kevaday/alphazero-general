...
nn = NNet(Game, args)
nn.load_checkpoint('./checkpoint/reversi_othello', 'iteration-0059.pkl')
...
edax = Popen("alphazero\\envs\\reversi_othello\\edax\\bin\\wEdax-x64-modern.exe --level 15", shell=True, stdout=PIPE, stdin=PIPE, stderr=STDOUT)
def read_stdout():
  out = b''
  while True:
