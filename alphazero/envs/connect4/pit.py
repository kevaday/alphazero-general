...
if __name__ == '__main__':
    ...
    from alphazero.envs.connect4.train_test import args
    ...
    # nnet players
    nn1 = NNet(Game, args)
    nn1.load_checkpoint('./checkpoint/connect4_new', 'iteration-0016.pkl')
    #nn2 = NNet(Game, args)
    ...
    player1 = MCTSPlayer(Game, nn1, args=args, verbose=True, draw_mcts=True, draw_depth=3)
    #args2 = args.copy()
